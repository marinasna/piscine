        ...
        <div class="form-box">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (isset($_POST['email'], $_POST['pseudo'], $_POST['nom'], $_POST['description'], $_POST['photo']) &&
                    ...
                    // Insérer dans la table utilisateur avec le rôle 'auteur'
                    $sql_user = "INSERT INTO utilisateur (role, email, pseudo) VALUES ('auteur', '$email', '$pseudo')";
                    if (mysqli_query($db_handle, $sql_user)) {
                        ...
                        if (mysqli_query($db_handle, $sql_profile)) {
                            echo "<p class='success-message'>Ajout de l'auteur réussi!</p>";
                        } else {
